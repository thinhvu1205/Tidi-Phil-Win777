...
{
    [SerializeField] private Button WhotGameButton;
    ...
    void reloadListGame()
    {
        ...
        //TODO:Tinh
        ItemGame whotGameBtn = Instantiate(WhotGameButton,m_MiniGameIconTf).GetComponent<ItemGame>();
        _AllGameIGs.Add(whotGameBtn);
        //TODO:EndTinh
